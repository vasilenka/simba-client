...
export default class RangeCore extends React.Component {
  ...
  componentDidMount = () => {
    ...
    this.container.parentNode.parentNode.addEventListener('mousemove', this.handleMouseMove);
    this.container.parentNode.parentNode.addEventListener('mouseup', this.handleMouseUp);
  };

  componentWillUnmount = () => {
    this.container.parentNode.parentNode.removeEventListener('mousemove', this.handleMouseMove);
    this.container.parentNode.parentNode.removeEventListener('mouseup', this.handleMouseUp);
    this.container.parentNode.parentNode.removeEventListener('mouseout', this.handleMouseUp);
